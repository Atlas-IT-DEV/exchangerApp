    ...
    <VStack width={"100%"} align="flex-start" spacing={"20px"}>
      ...
      <HStack width={"60%"} justify={"flex-start"}>
        ...
        <Text fontSize={"10px"} color={"white"} alignSelf={"center"}>
          YOUR REQUEST IS BEING PROCESSED (IT MIGHT TAKE UP TO 24 HOURS)
        </Text>
      </HStack>
      <HStack width={"60%"} justify={"flex-start"}>
        {arrow}
      ...
      <HStack width={"100%"} justify={"flex-start"}>
        {arrow}
        <Text fontSize={"10px"} color={"white"} alignSelf={"center"}>
          IF YOU HAVE ANY ISSUES WITH THIS TRANSACTION — PLEASE CONTACT SUPPORT
          TEAM BY CLICKING “LIVE SUPPORT” BUTTON IN THE MAIN MENU
        </Text>
      </HStack>
      <Button
        background={
